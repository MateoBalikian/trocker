// src/qml/components/ReportsPage.qml
import QtQuick
        ...
        Column {
            ...
            Item {
                ...
                Column {
                    ...
                    Text {
                        text: "Player metrics, speed zones, trajectories and heatmaps"
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: "Select an active video to generate reports"
            ...
            Rectangle {
                ...
                color: reportsMouse.containsMouse && hasActiveVideo ? theme.surface2 : theme.surface
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(45/255, 212/255, 128/255, 0.12)
                        anchors.verticalCenter: parent.verticalCenter
                    ...
                    Column {
                        ...
                        Text {
                            text: "Speed zones, trajectories, heatmaps and distance metrics"
