// src/qml/components/EditVideoPage.qml
import QtQuick
...
Item {
    ...
    Flickable {
        ...
        Column {
            ...
            Item {
                ...
                Column {
                    ...
                    Text {
                        ...
                        font.pixelSize: 34; font.letterSpacing: 1; color: theme.textPrimary
                    }
                    Text {
                        text: "Paint areas, trim and prepare videos before tracking"
                        font.family: theme.fontBody; font.pixelSize: 11; color: theme.textMuted
                    }
                }
            }
            ...
            Rectangle {
                id: videoCard
                width: parent.width; height: 64; radius: 12; color: theme.surface
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: "Select an active video to use the Edit Video tools"
            ...
            Rectangle {
                ...
                color: editMouse.containsMouse && hasActiveVideo ? theme.surface2 : theme.surface
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(255/255, 59/255, 48/255, 0.12)
                        anchors.verticalCenter: parent.verticalCenter
                    ...
                    Column {
                        ...
                        Text {
                            text: "Paint black areas and trim the video"
                            font.family: theme.fontBody; font.pixelSize: 10; color: theme.textMuted
                        }
                    }
                }
